...
public final class MediatorManager
{
	 ...
	 * "force" is True, registers and returns a new one automatically,
	...
	/**
	 * Reassociates the mediator of the old target to the new target, if it
	 * exists.
	 * 
	 * @param oldTarget
	 * @param newTarget
	 */
	public void resetTarget( IMediatorTarget oldTarget,
			IMediatorTarget newTarget )
	{
