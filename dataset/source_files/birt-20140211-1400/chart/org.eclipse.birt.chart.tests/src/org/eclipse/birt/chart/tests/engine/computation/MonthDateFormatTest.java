...
public class MonthDateFormatTest extends TestCase
{
	...
	public void testFormat( )
	{
		...
		locales.put( ULocale.CANADA, "2013-06" ); //$NON-NLS-1$
		locales.put( ULocale.CHINA, "2013-6" ); //$NON-NLS-1$
		...
		locales.put( ULocale.SIMPLIFIED_CHINESE, "2013-6" ); //$NON-NLS-1$
		locales.put( ULocale.TAIWAN, "2013/6" ); //$NON-NLS-1$
		locales.put( ULocale.TRADITIONAL_CHINESE, "2013/6" ); //$NON-NLS-1$
