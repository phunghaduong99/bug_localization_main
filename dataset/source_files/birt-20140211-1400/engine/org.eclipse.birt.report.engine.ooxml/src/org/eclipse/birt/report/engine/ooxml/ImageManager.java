...
public class ImageManager
{
	...
	public ImagePart getImagePart( IPart parent, String imageId, Image imageInfo )
			throws IOException
	{
		if ( imageId == null )
		...
		if ( imagePart == null )
		{
			...
			String uri = "/media/" + "image" + ( images.size( ) + 1 ) + "."
					+ format;
	...
	public ImagePart getImagePart( IPart parent, String imageId,
