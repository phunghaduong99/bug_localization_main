...
public class Core extends Component
{
	...
	public Core( Presentation presentation, String author, String title,
			String description, String subject ) throws IOException
	{
		String uri = "docProps/core.xml";
		Package pkg = presentation.getPackage( );
		super.initialize( pkg, uri, ContentTypes.CORE,
				RelationshipTypes.CORE, false );
		start( );
	...
	private void writeCoreProperty( String creator, String title,
