 ...
 * E.g. a field that contains an array of scalar values, or multiple documents 
 * fetched from a nested collection.
 * It servers to handle projection of additional result set sub-rows, flattening 
 * collection of nested documents.
 */
public class ArrayFieldValues
{
    // Map key is a fully-qualified field name; 
    // and Map value may be a list of field values, such as an array of scalar values,
    ...
    void addFieldValue( FieldMetaData fieldMD, List<?> value )
    {
        ...
        addFieldValue( fieldName, value, true );   // default is to iterate over each element in value list
    }
